    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <form action="/phar_addnew" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="exp_date" class="text-input">
                    </div>
                    ...
                    <div>
                        <button type="submit" class="btn btn-big" value="Submit">Add Product</button>
                    </div>
                </form>
