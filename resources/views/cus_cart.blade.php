...
<body id="top">
	<div class="container1">
		...
		<div class="navbar">
			...
			<div class="dropdown1">
				<button class="dropbtn" onclick="myFunction2()">CART
					<i class="fa fa-caret-down"></i>
				</button>
									...
									<form method="post">
										<table class="table">
											...
											<tr class="">
												...
												<td class="">
													<a class="product-remove" href="{{ url('delete-carts/'.$carts->id)}}">Remove</a>
												</td>
											</tr>
										...
										<a href="cus_checkout" class="btn btn-main pull-right">Place Order</a>
									</form>
								</div>
							</div>
						</div>
