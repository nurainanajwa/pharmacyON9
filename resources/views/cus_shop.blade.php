                    ...
                    <div class="col-md-4">
                        <div class="product-item">
                            <div class="product-thumb">
                                <img class="img-responsive" src="{{ asset('uploads/product/'.$item->image) }}" width="70px" height="70px"
                                    alt="product-img" />
                                <div class="preview-meta">
                                    <ul>
                                        <li>
                                            <a href="{{ url('cus_product_details'.$item->id)}}"><i class="tf-ion-ios-search-strong"></i></a>
                                        </li>
                            ...
                            <div class="product-content">
                                ...
                                <p class="price">MYR {{ $item->price }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
